...
$(document).ready (function(){
  ...
  //  console.log("mouseover on canvas");
    ...
    if(truth ===true){
      ...
      sendData("theCanvas"); //are we sending data TO the canvas or sending the data FROM the canvas?#
    }
  });
  // if we click on the button other stuff happens ...
    $( "#b" ).click(function( event ) {
      //stop submit the form, we will post it manually. PREVENT THE DEFAULT behaviour ...
       ...
       sendData("theButton"); //where do we define "theButton"?# HERE

     });

     function sendData(typeOfClick){ //not sure how to read this code?# This obtains the data being clicked on
